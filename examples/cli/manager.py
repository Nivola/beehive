...
'''
class MyCementBaseController(CementBaseController):
    def _dispatch(self):
        """
        ...
        #print self._commands
        #print self._commands
        #func = getattr(self._commands['controller'],
        #               self._commands['func_name'])
        #print func        
        self._process_commands()
        #print self._visible_commands
...
class MyBaseController(AbstractController):
    class Meta:
        label = 'base'
...
class MySecondController(AbstractController):
    class Meta:
        label = 'second'
        stacked_on = 'base'
        stacked_type = 'nested'
