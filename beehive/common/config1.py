...
class ConfigDbManager(object):
    ...
    def __repr__(self):
        return "<ConfigDbManager id='%s'>" % id(self)
    ...
    def create_table(db_uri):
        ...
        try:
            ...
            logger.info('Create config tables on : %s' % db_uri)
            del engine
        except exc.DBAPIError, e:
            raise ConfigDbManagerError(e)
    ...
    def remove_table(db_uri):
        ...
        try:
            ...
            logger.info('Remove config tables on : %s' % db_uri)
            del engine
        except exc.DBAPIError, e:
            raise ConfigDbManagerError(e)
