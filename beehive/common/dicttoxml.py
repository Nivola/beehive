...
"""
clone of https://github.com/quandyfactory/dicttoxml
"""
...
def unicode_me(something):
    ...
    Python 3 doesn't have a `unicode()` function, so `unicode()` is an alias for `str()`, but `str()` doesn't take a
