...
from beehive.common.task_v2 import BaseTask, task_step, prepare_or_run_task, run_sync_task
...
class TestTask(BaseTask):
    ...
    def task_step2(task, step_id, params, *args, **kvargs):
        ...
        prepared_task, code = prepare_or_run_task(TaskManager(task.controller),
                                                  'beehive.module.scheduler_v2.tasks.test2_task', params, sync=True)
...
class Test2Task(BaseTask):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.steps = [
            Test2Task.task_step0,
            Test2Task.task_step1
        ]
