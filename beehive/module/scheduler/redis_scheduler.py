...
class RedisScheduler(Scheduler):
    ...
    def __init__(self, app, schedule=None, max_interval=None, Publisher=None, lazy=False, sync_every_tasks=None,
                 **kwargs):
    ...
    def get_schedule(self):
        self.logger.warn('GET', self._schedule)
        return self._schedule

    def set_schedule(self, schedule):
        self.logger.warn('SET', schedule)
        self.data = schedule
    ...
    def setup_schedule(self):
        ...
        self.logger.warn(u'Setup schedules: %s' % schedule)
