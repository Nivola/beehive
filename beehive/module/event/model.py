...
class EventDbManager(object):
    ...
    def gets(self, oid=None, etype=None, data=None, 
        ...
        :param oid: event db id [optional]
        :param etype: list of event type [optional]
        :param opid: operation id [optional]
        :param op: operation [optional]
        :param source: event source [optional]
        :param dest: event destionation [optional]
