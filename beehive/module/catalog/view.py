...
class ListCatalogs(SwaggerApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": ListCatalogsResponseSchema}})
...
class GetCatalogParamsResponseSchema(ApiObjectResponseSchema):
    ...
    services = fields.Nested(
        GetCatalogParamsServicesResponseSchema,
        many=True,
        required=True,
        allow_none=True,
    )
...
class GetCatalog(SwaggerApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetCatalogResponseSchema}})
...
class ListEndpoints(SwaggerApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": ListEndpointsResponseSchema}})
...
class GetEndpoint(SwaggerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetEndpointResponseSchema}})
...
class CatalogAPI(ApiView):
    ...
    def register_api(module, **kwargs):
        rules = [
            ...
            (
                "%s/endpoints/<oid>/perms" % module.base_path,
                "GET",
                GetEndpointPerms,
                {},
            ),
