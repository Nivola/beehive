...
class AuthManagerTestCase(BeehiveTestCase):
    ...
    def test_get_permission(self):
        ...
        res = self.manager.get_permission_by_object(
            objid="c1.o1.g1.*", objtype="resource", objdef="container.org.group.vm"
        )
