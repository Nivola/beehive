...
from beecell.remote import BadRequestException, UnauthorizedException, ConflictException
...
class AuthTestCase(BeehiveTestCase):
    ...
    def test_add_role(self):
        data = {"role": {"name": "role_prova", "desc": "role_prova", "alias": "prova"}}
    ...
    def test_add_user_attributes(self):
        ...
        self.post(
            "/v1.0/nas/users/{oid}/attributes",
            params={"oid": "user_prova@local"},
            data=data,
        )
    ...
    def test_delete_user_attributes(self):
        self.delete(
            "/v1.0/nas/users/{oid}/attributes/{aid}",
    ...
    def test_add_user_role(self):
        data = {"user": {"roles": {"append": [("Guest", "2019-12-31")]}}}
        self.put("/v1.0/nas/users/{oid}", params={"oid": "user_prova@local"}, data=data)
    ...
    def test_add_group_twice(self):
        data = {"group": {"name": "grp_prova", "desc": "grp_prova", "active": True}}
        self.post("/v1.0/nas/groups", data=data)
    ...
    def test_add_group_user(self):
        data = {"group": {"users": {"append": ["admin@local"]}}}
        self.put("/v1.0/nas/groups/{oid}", params={"oid": "grp_prova"}, data=data)
    ...
    def test_remove_group_user(self):
        data = {"group": {"users": {"remove": ["admin@local"]}}}
        self.put("/v1.0/nas/groups/{oid}", params={"oid": "grp_prova"}, data=data)

    def test_add_group_role(self):
        data = {"group": {"roles": {"append": [("ApiSuperAdmin", "2019-12-31")]}}}
        self.put("/v1.0/nas/groups/{oid}", params={"oid": "grp_prova"}, data=data)
    ...
    def test_remove_group_role(self):
        data = {"group": {"roles": {"remove": ["ApiSuperAdmin"]}}}
        self.put("/v1.0/nas/groups/{oid}", params={"oid": "grp_prova"}, data=data)
    ...
    def test_add_object(self):
        global oid
        data = {"objects": [{"subsystem": "auth", "type": "Role", "objid": "prova", "desc": "prova"}]}
